...
// import { X, Store, Trash2, Loader2, AlertCircle, PackageOpen, Phone, MapPin, PackagePlus, ExternalLink } from 'lucide-react';
...
//   const fetchMyShops = async (ignoreRef?: { current: boolean }) => {
//     if (!user) return;

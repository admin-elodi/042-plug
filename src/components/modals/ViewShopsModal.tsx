...
import { X, Store, Phone, MapPin, Loader2, AlertCircle, PackageOpen, MessageCircle } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const fetchShops = async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(
          `
          id, business_name, phone, address, bank_name, account_number, account_name, created_at,
          products (

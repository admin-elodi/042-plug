...
// import { X, Store, Phone, MapPin, Loader2, AlertCircle, PackageOpen, MessageCircle, ExternalLink } from 'lucide-react';
// import { Link } from 'react-router-dom';
// import { supabase } from '@/lib/supabaseClient';

// interface ViewShopsModalProps {
...
// export const ViewShopsModal: React.FC<ViewShopsModalProps> = ({ category, onClose }) => {
...
//             <span>Category Directory: {category.title}</span>
//           </div>
...
//                 No one has registered a shop in {category.title} yet. Be the first!
//               </p>
//             </div>
//           )}
...
//                       to={`/shop/${shop.slug}`}
//                       onClick={onClose}
//                       className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] font-medium whitespace-nowrap"
//                     >
...
//                         <div key={product.id} className="border-t border-slate-800/70 pt-3">
...
//                           </div>
//                           {product.description && (
//                             <p className="text-[11px] text-slate-400 mt-1">{product.description}</p>
//                           )}
...
//                             className="flex items-center gap-1.5 mt-2 w-fit px-3 py-1.5 rounded-lg bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 text-[11px] font-semibold transition-colors"
//                           >
...
//                                   <div
//                                     key={media.id}
//                                     className="aspect-square rounded-md overflow-hidden bg-slate-900 border border-slate-800"
//                                   >
